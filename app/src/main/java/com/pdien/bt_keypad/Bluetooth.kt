...
import com.pdien.bt_keypad.databinding.ActivityBluetoothBinding
...
open class Bluetooth : AppCompatActivity(), OnItemClickListener {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.action) {
                BluetoothAdapter.ACTION_DISCOVERY_STARTED -> {
                    Toast.makeText(this@Bluetooth, "Bluetooth Scanning Started", Toast.LENGTH_SHORT).show()
                }
                BluetoothAdapter.ACTION_DISCOVERY_FINISHED -> {
                    Toast.makeText(this@Bluetooth, "Bluetooth Scanning Finished", Toast.LENGTH_SHORT).show()
                }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchFab.setOnClickListener{ startBluetoothScan() }

        //val recyclerView: RecyclerView = findViewById(R.id.recView)
        customAdapter = CustomAdapter(deviceList, this)
        val layoutManager = LinearLayoutManager(applicationContext)
        binding.recView.layoutManager = layoutManager
        binding.recView.adapter = customAdapter
        getPairedDevices()

        if(savedInstanceState == null) {
            supportFragmentManager.beginTransaction().apply {R.layout.activity_main}
        }
    }
    ...
    private fun connectDevice(mac: String) {
        ...
        try {
            ...
            try {
                ...
                Toast.makeText(this@Bluetooth, "Unable to connect to device", Toast.LENGTH_SHORT).show()
            }
            Toast.makeText(this@Bluetooth, "Socket creation failed", Toast.LENGTH_SHORT).show()
        }
    }
